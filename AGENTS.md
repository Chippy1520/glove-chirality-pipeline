...
- Lightweight modern Tkinter GUI that delegates pipeline operations to the public CLI, runs TensorBoard concurrently, and includes individual-decision explanation plus split-aware model comparison.
